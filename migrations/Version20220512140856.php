 ...
 */
final class Version20220512140856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_poem (category_id INT NOT NULL, poem_id INT NOT NULL, INDEX IDX_A9E20BDD12469DE2 (category_id), INDEX IDX_A9E20BDD8938791B (poem_id), PRIMARY KEY(category_id, poem_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, poem_id INT NOT NULL, content VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_9474526C8938791B (poem_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE menu (id INT AUTO_INCREMENT NOT NULL, poem_id INT DEFAULT NULL, category_id INT DEFAULT NULL, page_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, menu_order INT DEFAULT NULL, is_visible TINYINT(1) NOT NULL, link VARCHAR(255) DEFAULT NULL, INDEX IDX_7D053A938938791B (poem_id), INDEX IDX_7D053A9312469DE2 (category_id), INDEX IDX_7D053A93C4663E4 (page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE poem (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, content LONGTEXT DEFAULT NULL, featured_text VARCHAR(100) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C8938791B FOREIGN KEY (poem_id) REFERENCES poem (id)');
        $this->addSql('ALTER TABLE menu ADD CONSTRAINT FK_7D053A938938791B FOREIGN KEY (poem_id) REFERENCES poem (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category_poem DROP FOREIGN KEY FK_A9E20BDD12469DE2');
        ...
        $this->addSql('ALTER TABLE category_poem DROP FOREIGN KEY FK_A9E20BDD8938791B');
        $this->addSql('ALTER TABLE comment DROP FOREIGN KEY FK_9474526C8938791B');
        $this->addSql('ALTER TABLE menu DROP FOREIGN KEY FK_7D053A938938791B');
